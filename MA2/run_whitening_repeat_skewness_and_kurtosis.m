...
% perform repeated whitening runs for sknewess and kurtosis dataset
...
save('results_whitening_repeat_skewness_and_kurtosis.mat','theta_all');
...
save('tv_and_dists_whitening_repeat_skewness_and_kurtosis.mat','tv_distance','theta_dist');
