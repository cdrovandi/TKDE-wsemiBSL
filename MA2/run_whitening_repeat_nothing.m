...
% perform repeated whitening runs for original dataset
...
save('results_whitening_repeat_nothing.mat','theta_all');
...
save('tv_and_dists_whitening_repeat_nothing.mat','tv_distance','theta_dist');
